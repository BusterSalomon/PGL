...
print(lights)
sleep(1)
lights = zone_controller.control_zones(True, "PIR2_Pigeon")
print(lights)
sleep(2)
lights = zone_controller.control_zones(True, "PIR3_Pigeon")
print(lights)
sleep(2)
lights = zone_controller.control_zones(True, "PIR4_Pigeon")
print(lights)
sleep(2)
lights = zone_controller.control_zones(True, "PIR5_Pigeon")
print(lights)
sleep(2)
lights = zone_controller.control_zones(True, "PIR4_Pigeon")
print(lights)
